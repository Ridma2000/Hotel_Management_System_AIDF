          ...
          <div className="relative flex items-center">
            <div className="relative flex-grow">
              <Input
                ...
                className="bg-white/10 backdrop-blur-md text-sm sm:text-base text-white placeholder:text-white/60 border-white/20 rounded-full py-6 pl-5 pr-36 w-full transition-all focus:bg-white/20 focus:border-white/40"
              />
            </div>
            ...
            <button
              ...
              className="absolute right-2 h-[75%] my-auto bg-white text-black rounded-full px-4 sm:px-5 flex items-center gap-x-2 hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed font-medium"
            >
              {isSearching ? (
                <>
